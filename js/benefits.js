/* ==========================================================================
   LMW Travel — Benefits & Partnerships Page Controller
...
(function () {
  ...
  var hero = document.querySelector('.benefits-hero');
  ...
  window.addEventListener('load', function () {
    requestAnimationFrame(function () {
      if (hero) hero.classList.add('benefits-hero--ready');
  ...
  var heroImage = document.querySelector('.benefits-hero__image');
